...
#|:Nt: D nestD funcTns must come bfr dy r usD
#|:Nt: D nestD funcTns inherit d vars frm the parent func 
...
#|:GlobalisaTn of Omeg is needD so dt d other func sees d val f Omeg
def func_ode45_v2(Omeg,qn,tend,tol):
   # global Omeg #|Error: name Omeg is parameter and global. 
   global Omeg_shared
   ...
   #|:Uses RK45 Dormand Prince by default already. 
   #|...U cn use scipy.integrate.RK45()
   #|:Events can be added.
